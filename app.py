...
try:
    ...
    with opciones:
        ...
        st.write("Notemos que el promedio aritmetico esta dado por $\left(\displaystyle\prod_{i=0}^n S_{t_i}\right)^{\frac{1}{n}} = e^{\left(\frac{1}{n}\right) \cdot \left(log\displaystyle\prod_{i=0}^n S_{t_i}\right)} = e^{\frac{1}{n} * \cdot \displaystyle\sum_{i=1}^n log S_{t_i}}$")
